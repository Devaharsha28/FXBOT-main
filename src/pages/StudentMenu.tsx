...
import { LogOut, User, Activity, CheckCircle, Clock } from "lucide-react";
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 pb-20 md:pb-0">
            ...
            <header className="glass fixed top-0 left-0 right-0 z-50 border-b-0">
                <div className="container mx-auto px-4 h-16 flex justify-between items-center">
                    ...
                    <Button variant="ghost" size="icon" onClick={handleLogout} className="hover:bg-red-50 hover:text-red-500">
                        <LogOut className="w-5 h-5" />
                    </Button>
                </div>
            </header>

            <main className="container mx-auto p-4 space-y-8 pt-20">
                {/* Stats Grid */}
