            ...
            <header className="fixed top-0 w-full z-50 glass border-b-0">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-2 animate-slide-in-right">
                        <img src="/logo.jpg" alt="FXBOT Logo" className="w-10 h-10 rounded-xl object-cover shadow-sm" />
            ...
            <footer className="border-t py-12 mt-auto bg-background">
                <div className="container mx-auto px-4 text-center">
                    <div className="flex items-center justify-center gap-2 mb-4 opacity-80">
                        <img src="/logo.jpg" alt="FXBOT Logo" className="w-8 h-8 rounded-lg object-cover" />
