                                    ...
                                    {issue.proof_files && issue.proof_files.length > 0 && (
                                        <div className="space-y-2">
                                            ...
                                            <div className="grid grid-cols-3 gap-2">
                                                {issue.proof_files.map((_, i) => (
                                                    <div key={i} className="aspect-square bg-white/40 border border-white/20 rounded-lg flex items-center justify-center text-xs font-medium text-muted-foreground hover:bg-white/60 transition-colors cursor-pointer">
                                                        File {i + 1}
                                                    </div>
                                                ))}
                                            </div>
